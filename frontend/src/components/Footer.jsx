        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3 mb-6">
              ...
              <a href="https://wa.me/447474784070?text=Hi%2C%20I%20want%20to%20get%20my%20online%20cricket%20ID" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center hover:bg-green-700 transition">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
