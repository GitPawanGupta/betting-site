  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        description="Get instant cricket betting ID from Swamiji Online - India's most trusted betting ID provider. 5000+ games, 24/7 support, fast withdrawals. WhatsApp: +447848431366"
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-purple-900 via-purple-800 to-secondary stars-bg">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 text-center">
          ...
          <a 
            href="https://wa.me/447848431366?text=Hi%2C%20I%20want%20to%20get%20my%20online%20cricket%20ID" 
            target="_blank" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-highlight/50 transition-all duration-300">
              ...
              <div className="flex justify-center">
                <a 
                  href="https://wa.me/447848431366?text=Hi%2C%20I%20want%20to%20get%20my%20allpanelexch9%20ID" 
                  target="_blank" 
                  rel="noopener noreferrer"
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-highlight/50 transition-all duration-300">
              ...
              <div className="flex justify-center">
                <a 
                  href="https://wa.me/447848431366?text=Hi%2C%20I%20want%20to%20get%20my%20cricxbet99%20ID" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-highlight text-white px-6 py-2 rounded-full hover:bg-orange-600 transition font-semibold"
                >
